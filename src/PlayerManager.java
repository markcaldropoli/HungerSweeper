...
public class PlayerManager {
	...
	public void setTraps() {
		...
		Traps mine = new Traps("you stepped on a mine!", "Slowly lift your foot?", "Put a rock on your foot then move it?", "The mine doesn't go off", "The mine explodes under you!", 50, false, 6);
	...
	public void update() {
		...
		else if(players.size() <= 5 && players.get(0).getBoundary() > 3) {
	...
	public void fight(Player a, Player b) {
		...
		while(a.getHealth() > 0 && b.getHealth() > 0) {
			boolean one = a.fight(b);
			boolean two = b.fight(a);
